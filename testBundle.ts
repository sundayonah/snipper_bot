...
class TokenBuyer {
        ...
        const buyTokens = async () => {
            try {
                for (const wallet of this.wallets) {
                    await this.buyTokenForWallet(wallet);
    ...
    private async buyTokenForWallet(wallet: Wallet): Promise<void> {
        try {
...
// Example usage
async function main() {
    const PROVIDER_URL = "https://base-sepolia.g.alchemy.com/v2/k876etRLMsoIcTpTzkkTuh3LPBTK96YZ" // 'https://base.llamarpc.com' //'https://base.drpc.org' // 'https://base.drpc.org'// 'https://base.drpc.org';
    const UNISWAP_V2_ROUTER = "0x4752ba5DBc23f44D87826276BF6Fd6b1C372aD24";
    const TARGET_TOKEN = '0x756355B72407E28Fa62D260a456c0a3A78f9C105';

    // Private keys array
    const PRIVATE_KEYS = ['49f3402f224229d4f565d5827c058e3cefcee09cc4f5bb134daca9c14a0a745b'];
